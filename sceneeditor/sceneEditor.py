...
class myLevelEditor(AppShell):
    ...
    def appInit(self):
        ...
        if self.enableControl:
            self.startControl(self.controlType, [])
    ...
    def openScene(self):
        ...
        if (self.CurrentFileName or self.Dirty):
            saveScene = tkMessageBox._show("Load scene", "Save the current scene?", icon=tkMessageBox.QUESTION,
        ...
        if self.CurrentFileName != None:
            self.parent.title(
                'Scene Editor - ' + Filename.fromOsSpecific(self.CurrentFileName).getBasenameWoExtension())
        if self.lightingPanel != None:
    ...
    def openParticlePanel(self):
        ...
        if (len(AllScene.particleDict) == 0):
            ...
            self.particlePanel = seParticlePanel.ParticlePanel(particleEffect=theeffect,
                                                               effectsDict=AllScene.particleDict)
    ...
    def keyboardControlTask(self, task):
        ...
        self.transNodeKeyboard.setPosHpr((self.keyControlEventDict['KeyRight'] * self.keyboardSpeedDict['SpeedRight'] -
                                          self.keyControlEventDict['KeyLeft'] * self.keyboardSpeedDict[
                                              'SpeedLeft']) * delta,
                                         (self.keyControlEventDict['KeyForward'] * self.keyboardSpeedDict[
                                             'SpeedForward'] - self.keyControlEventDict['KeyBackward'] *
                                          self.keyboardSpeedDict['SpeedBackward']) * delta,
                                         (self.keyControlEventDict['KeyUp'] * self.keyboardSpeedDict['SpeedUp'] -
                                          self.keyControlEventDict['KeyDown'] * self.keyboardSpeedDict[
                                              'SpeedDown']) * delta,
                                         (self.keyControlEventDict['KeyTurnLeft'] * self.keyboardSpeedDict[
                                             'SpeedTurnLeft'] - self.keyControlEventDict['KeyTurnRight'] *
                                          self.keyboardSpeedDict['SpeedTurnRight']) * delta,
                                         (self.keyControlEventDict['KeyTurnUp'] * self.keyboardSpeedDict[
                                             'SpeedTurnUp'] - self.keyControlEventDict['KeyTurnDown'] *
                                          self.keyboardSpeedDict['SpeedTurnDown']) * delta,
                                         (self.keyControlEventDict['KeyRollLeft'] * self.keyboardSpeedDict[
                                             'SpeedRollLeft'] - self.keyControlEventDict['KeyRollRight'] *
                                          self.keyboardSpeedDict['SpeedRollRight']) * delta)
        ...
        overAllScale = self.keyControlEventDict['KeyScaleUp'] * self.keyboardSpeedDict['SpeedScaleUp'] - \
                       self.keyControlEventDict['KeyScaleDown'] * self.keyboardSpeedDict['SpeedScaleDown']
        newScale = Point3(scale.getX() + (
            overAllScale + self.keyControlEventDict['KeyScaleXUp'] * self.keyboardSpeedDict['SpeedScaleXUp'] -
            self.keyControlEventDict['KeyScaleXDown'] * self.keyboardSpeedDict['SpeedScaleXDown']) * delta,
                          scale.getY() + (
                              overAllScale + self.keyControlEventDict['KeyScaleYUp'] * self.keyboardSpeedDict[
                              'SpeedScaleYUp'] - self.keyControlEventDict['KeyScaleYDown'] * self.keyboardSpeedDict[
                                  'SpeedScaleYDown']) * delta,
                          scale.getZ() + (
                              overAllScale + self.keyControlEventDict['KeyScaleZUp'] * self.keyboardSpeedDict[
                              'SpeedScaleZUp'] - self.keyControlEventDict['KeyScaleZDown'] * self.keyboardSpeedDict[
                                  'SpeedScaleZDown']) * delta
                          )
    ...
    def monitorSelectedNodeTask(self, task):
        ...
        if self.nodeSelected != None:
            ...
            if ((self.oPos != pos) or (self.oScale != scale) or (self.oHpr != hpr)):
                ...
                self.scaleLabel['text'] = "Scale      : X: %2.2f Y: %2.2f Z: %2.2f" % (
