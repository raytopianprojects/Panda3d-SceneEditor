...
class ParticlePanel(AppShell):
    ...
    def __init__(self, particleEffect = None, effectsDict={}, **kw):
        ...
        self.selectEffectNamed(list(self.effectsDict.keys())[0])
    ...
    def createInterface(self):
        ...
        self.rendererSpriteSTTexture = self.createRadiobutton(
            ...
            self.rendererSpriteSourceType, None,
    ...
    def updateEffectsMenus(self):
        ...
        keys = list(self.effectsDict.keys())
        keys.sort()
        for name in keys:
    ...
    def updateParticlesMenus(self):
        ...
        names = list(map(lambda x: x.getName(), particles))
        names.sort()
        for name in names:
    ...
    def updateForceGroupMenus(self):
        ...
        names = list(map(lambda x: x.getName(), forceGroupList))
        names.sort()
        for name in names:
    ...
    def selectEffectNamed(self, name):
        ...
        if effect is not None:
            ...
            self.particles = list(self.particleEffect.getParticlesList())[0]
    ...
    def addForceWidget(self, forceGroup, force):
        ...
        count = 0
        for f in forceGroup:
            if f.getClassType() is force.getClassType():
                count += 1
